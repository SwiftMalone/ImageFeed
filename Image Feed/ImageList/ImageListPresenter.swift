...
public protocol ImagesListViewPresenterProtocol: AnyObject {
    ...
    func configCell(_ cell: ImagesListCell, at indexPath: IndexPath)
...
final class ImagesListViewPresenter: ImagesListViewPresenterProtocol {
    ...
    @MainActor func configCell(_ cell: ImagesListCell, at indexPath: IndexPath) {
    ...
    func likePhoto(at indexPath: IndexPath) {
        ...
        imagesListService.changeLike(photoId: photo.id, isLike: !photo.isLiked) { [weak self] result in
            DispatchQueue.main.async {
                ...
                case .failure:
                    self.view?.showErrorAlert(message: "Failed to update like status")
                }
            }
        }
    }
